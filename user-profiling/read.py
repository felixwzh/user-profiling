...
item_04=get_items("s04.txt")
item_05=get_items("s05.txt")
item_06=get_items("s06.txt")
item_07=get_items("s07.txt")
item_11=get_items("s11.txt")
...
get_user_list("s04.txt",item_04)
get_user_list("s05.txt",item_05)
get_user_list("s06.txt",item_06)
get_user_list("s07.txt",item_07)
get_user_list("s11.txt",item_11)
...
def encode(item_list=item_all,user_list_tmp=user_list,*index):
    ...
    for item in item_list:
        fake_user[item]='None'
    fake_user["LABEL"]='0'
    user_list_tmp.insert(0,fake_user)
    #end
...
user_list_onehot = encode(item_all,user_list,0,3,4,8,9,10,11,12,13,15,16,17,18,19,20,21,22,)
